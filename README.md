...
Code is published to Github pages automatically after merging a pull request to the `master` branch via a Github Action [deploy-pages](https://github.com/wgnhs/data-pres-2018/actions/workflows/deploy-pages.yml)
...
4. Sign into Github and navigate to this repository https://github.com/wgnhs/data-pres-2018
5. Click Pull requests then New pull requests (or go to https://github.com/wgnhs/data-pres-2018/compare)
...
9. After the pull request is successfully merged, the [deploy-pages action](https://github.com/wgnhs/data-pres-2018/actions/workflows/deploy-pages.yml) will be trigged. This action builds the code and pushes it to the gh-pages branch. Follow progress in https://github.com/wgnhs/data-pres-2018/actions . 
10. After the code is pushed to the gh-pages branch by the [deploy-pages action](https://github.com/wgnhs/data-pres-2018/actions/workflows/deploy-pages.yml), Github automatically triggers a built-in action [pages-build-deployment](https://github.com/wgnhs/data-pres-2018/actions/workflows/pages/pages-build-deployment) to publish the code to https://wgnhs.github.io/data-pres-2018 . Progress of this action also appears https://github.com/wgnhs/data-pres-2018/actions . 

The [deploy-pages action](https://github.com/wgnhs/data-pres-2018/actions/workflows/deploy-pages.yml) performs the following tasks:
