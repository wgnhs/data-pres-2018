!(function(e,t){"object"==typeof exports&&"undefined"!=typeof module?t(exports,require("lit-element"),require("wgnhs-common"),require("wgnhs-router"),require("wgnhs-styles"),require("wgnhs-pdf"),require("wgnhs-layout")):"function"==typeof define&&define.amd?define(["exports","lit-element","wgnhs-common","wgnhs-router","wgnhs-styles","wgnhs-pdf","wgnhs-layout"],t):t((e=e||self).app={},e["wgnhs-common"],e["wgnhs-common"],e["wgnhs-router"],e["wgnhs-common"],e["wgnhs-pdf"],e["wgnhs-layout"])})(this,function(e,t,i,o,r,n,s){"use strict";class l{constructor(e){Object.assign(this,e),this.id||(this.id=i.genId())}activate(e){let t=null;const i=e.detail.checked;return e.toggleable&&i&&(t={id:e.id,context:e,resolve:function(t){return t[e.prop]===e.value}}),t}}class a{constructor(){this.id=i.genId()}get next(){return t.html`
      <input type="checkbox">
    `}handle(e){let t=null;return e.target.nextElementSibling.checked&&(t={id:e.id,context:e,resolveGroup:function(t){return!e.group.prop||e.group[e.group.prop]===t[e.group.prop]},resolve:function(t){return!!t[e.prop]}}),t}}class c{constructor(e){this.id=i.genId(),this.gtName=e?"after":"at least",this.ltName=e?"before":"less than"}get next(){return t.html`
      <select>
        <option value="gt">${this.gtName}</option>
        <option value="lt">${this.ltName}</option>
      </select>
      <input type="text">
    `}handle(e){let t=null;e.gt=((e,t)=>e>=t),e.lt=((e,t)=>e<t);const i=e[e.target.nextElementSibling.value],o=e.target.nextElementSibling.nextElementSibling.value;return o&&(t={id:e.id,context:e,resolveGroup:function(t){return!e.group.prop||e.group[e.group.prop]===t[e.group.prop]},resolve:function(t){let r=!!t[e.prop];return r&&(r=i(t[e.prop],o)),r}}),t}}class d{constructor(){this.id=i.genId()}get next(){return t.html`
    ...
    `}render(){return t.html`
      <dl data-element="table">
        ${Object.entries(this.info).filter(e=>!p.includes(e[0])).filter(e=>!!e[1]).map((e,i)=>t.html`
      <dt class="label" title="${h[e[0]]?h[e[0]].desc:e[0]}">
        <label for="${this.genId(i)}" >
          ${h[e[0]]?h[e[0]].title:e[0]}
        </label>
      </dt>
      <dd class="detail" title="${h[e[0]]?h[e[0]].desc:e[0]}">
    ...
    `}}customElements.define("table-layout",w);class y extends t.LitElement{static get layoutName(){return"geophysical log"}static include(e,i){return t.html`<log-layout .info=${e} .context=${i}></log-layout>`}static get properties(){return{info:{type:Object},context:{type:Object}}}constructor(){super()}static get styles(){return t.css`
    `}render(){return t.html`
    ...
    `]}renderData(e,t){return S.getLayout(t)(e,this)}render(){let e=this.siteinfo?this.siteinfo.Latitude:null,i=this.siteinfo?this.siteinfo.Longitude:null,o=this.siteinfo?this.siteinfo.Wid:null;return t.html`
      ${this.siteinfo?t.html`
        ...
        ${this.renderData({Latitude:e,Longitude:i,WID:o})}
        ${this.siteinfo.datas.map(e=>t.html`
          <app-collapsible open>
            <span slot="header" class="name">${e.Data_Type}</span>
            <div slot="content">
        ...
        `)}
      `:""}
    `}fireClearSelection(){i.dispatch(this,"clear-selection",{},!0,!0)}fireZoomToSite(){i.dispatch(this,"zoom-to-site",{params:this.siteinfo},!0,!0)}}customElements.define("site-details",x);customElements.define("filter-summary",class extends t.LitElement{static get properties(){return{counts:{type:Array,attribute:!1}}}constructor(){super()}static get styles(){return t.css`
    li[disabled] {
    ...
    <div>
      ...
      <ul>
        ...
        <li ?disabled=${!e.included}>
          ${e.current} of ${e.total} <span class="name">${e.name}</span> sites
          ${e.filteredBy.length>0?t.html`
          (filtered by ${e.filteredBy.join(", ")})
          `:""}
        </li>
        `)}
      </ul>
    </div>
    `:t.html``}handleFiltered(e){e.detail&&(this.counts=e.detail.counts)}connectedCallback(){super.connectedCallback(),this.__filteredHandler=this.handleFiltered.bind(this),document.addEventListener("filtered",this.__filteredHandler)}disconnectedCallback(){document.removeEventListener("filtered",this.__filteredHandler),super.disconnectedCallback()}});class $ extends t.LitElement{static get properties(){return{include:{type:Array,attribute:!1},filter:{type:Array,attribute:!1},matchClass:{type:String,attribute:!1},sources:{type:Array,attribute:!1}}}static get styles(){return[...r.styles,t.css`
      .field {
        display: grid;
        grid-template-columns: 40% 1fr;
        grid-gap: var(--border-radius);
    ...
    `)}get _eventHandlers(){return{open:(e,t)=>{e.open=t.detail.value}}}_handle(e){return t=>{const i=this._eventHandlers[t.type];i&&(i(e,t),this.requestUpdate("handle_"+t.type))}}_handleGroup(e,t){const i=e.id,o=e.activate.bind(e),r=this[t],n=this.requestUpdate.bind(this);return s=>{const l={};l.id=i,l.toggleable=e.toggleable,l.detail=s.detail,l.prop=e.prop,l.value=e[e.prop],E(r,i);let a=o(l);a&&r.push(a),n(t)}}_handleControl(e,t,i){const o=t.id,r=t.handle.bind(t),n=this[i],s=this.requestUpdate.bind(this);return t=>{const l={};l.id=o,l.group=e,l.target=t.currentTarget.querySelector("#"+o),l.prop=l.target.name,E(n,o);let a=r(l);a&&n.push(a),s(i)}}updated(e){const t=e.has("matchClass")||e.has("include")||e.has("filter")||e.has("sources");if(this.sources&&t){const e=$.runFilter({matchClass:this.matchClass,incl:this.include,filt:this.filter,sources:this.sources}),t=$.getResultsInfo(this.matchClass,this.include,this.filter,this.sources,e);i.dispatch(this,"filtered",{activePoints:e,counts:t},!0,!0)}}init(e,t){this.filterGroups.forEach(t=>{t.sections.forEach(t=>{Object.entries(t.fields).forEach(t=>{t[1].controls.forEach(i=>{i.init&&i.init(e[t[0]])})})})}),this.sources=t}static runFilter({matchClass:e,incl:t,filt:i,sources:o}){return o.map(o=>{const r=new Set;return Object.entries(o._layers).forEach(o=>{(function(o){let r=t.length>0&&t.reduce((e,t)=>e||t.resolve(o),!1),n=i.filter(e=>e.resolveGroup(o)),s=r&&n.length<1;return r&&!s&&(s="ALL"===e?n.reduce((e,t)=>e&&t.resolve(o),!0):n.reduce((e,t)=>e||t.resolve(o),!1)),s})(o[1].feature.properties)&&r.add(""+f.getSiteCode(o[1].feature.properties))}),r})}static getResultsInfo(e,t,i,o,r){return o.map((o,n)=>{let s={};s.name=o.options.name,s.included=t.some(e=>e.context.value===o.options.name),s.filteredBy=i.reduce((e,t)=>(t.context.group[t.context.group.prop]===o.options.name&&e.push(h[t.context.prop]?h[t.context.prop].title:t.context.prop),e),[]),s.matchClass=e;let l=Object.entries(o._layers);return s.total=l.length,s.current=r[n].size,s})}constructor(){super(),this.genId=(function(){const e={};return function(t){return e[t]||(e[t]=i.genId()),e[t]}})(),this.include=[],this.filter=[],this.filterGroups=g}}customElements.define("map-filter",$);const E=(e,t)=>{for(var i=e.findIndex(e=>e.id===t);i>=0;i=e.findIndex(e=>e.id===t))e.splice(i,1)};window.siteMap=new f,window.sidebar=document.querySelector("#sidebar"),window.pdfPanel=document.querySelector("#sketch"),document.querySelectorAll("site-details").forEach(function(e){e.pdfpanel=window.pdfPanel}),window.filter=document.querySelector("#filter"),window.siteMap.once("init",function(){window.siteData=new u(window.siteMap.layers),window.aggrData=siteData.aggrData,filter.init(window.siteData.uniques,window.siteMap.layers);var e=function(){window.pdfPanel.hide(),document.querySelectorAll("site-details").forEach(function(e){e.siteinfo=null})};async function t(t){return e(),document.querySelectorAll("site-details").forEach(function(e){e.siteinfo=t}),!0}window.router=new o.SiteRouter,window.router.addRoute({name:"entry",url:"/",onEnter:function(t,i){window.siteMap.clearSelection(),e(),document.querySelector("#app").setAttribute("data-view","app"),window.sidebar.switchTab("default"),window.siteMap.setVisibility(!0)},onExit:function(e,t){}}),window.router.addRoute({name:"view",url:"/view/:Site_Code",onEnter:function(e,i){let o=e.params(),r=window.siteMap.selectSite(o);r?(document.querySelectorAll("site-details").forEach(function(e){e.printLayout=!1}),t(r).then(()=>{document.querySelector("#app").setAttribute("data-view","app"),window.sidebar.switchTab("details"),window.siteMap.setVisibility(!0)})):window.router.clearRoute()},onExit:function(e,t){}}),window.router.addRoute({name:"print",url:"/print/:Site_Code",onEnter:function(e,i){let o=e.params(),r=window.siteMap.selectSite(o);r?(document.querySelectorAll("site-details").forEach(function(e){e.printLayout=!0}),t(r).then(()=>{document.querySelector("#app").removeAttribute("data-view"),window.sidebar.switchTab("details"),window.siteMap.setVisibility(!1)})):window.router.clearRoute()},onExit:function(e,t){}}),window.router.router.transitionService.onEnter({},()=>{document.querySelector("#spinner").setAttribute("data-closed",!0)}),window.router.start(),window.siteMap.on("interaction",e=>{e.Site_Code?window.router.setRoute("view",e):window.router.clearRoute()})}),document.addEventListener("clear-selection",function(e){window.router.clearRoute()}),document.addEventListener("zoom-to-site",function(e){window.siteMap.zoomToPoint(e.detail.params)}),document.addEventListener("toggle-print",function(e){e.detail.on?window.router.setRoute("print",e.detail.params):window.router.setRoute("view",e.detail.params)}),document.addEventListener("toggle-pdf-panel",function(e){window.siteMap.setVisibility(e.detail.closed),e.detail.closed?window.pdfPanel.setAttribute("data-closed",!0):window.pdfPanel.removeAttribute("data-closed")}),document.addEventListener("filtered",function(e){window.siteMap.updatePoints(e.detail.activePoints)}),e.MapFilter=$,e.SiteDetails=x,Object.defineProperty(e,"__esModule",{value:!0})});
