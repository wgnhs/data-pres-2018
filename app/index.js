(function (global, factory) {
  ...
  class TableLayout extends litElement.LitElement {
    ...
    render() {
      ...
      entries = entries.map((el, index) => litElement.html`
  ...
  class RockCoreLayout extends litElement.LitElement {
    static get layoutName() {
      return 'rock core';
    }

    static include(info, context) {
      return litElement.html`<rock-core-layout .info=${info} .context=${context}></rock-core-layout>`;
    }
  ...
  class SiteDetails extends litElement.LitElement {
    ...
    render() {
      ...
      ${(!this.siteinfo)? '' : litElement.html`
        ...
        ${this.siteinfo.datas.slice().reverse().map((props) => litElement.html`
  ...
  class MapFilter extends litElement.LitElement {
    ...
    updated(changed) {
      ...
      if (this.sources && isNeeded) {
        wgnhsCommon.dispatch(this, 'filter-change', {
          matchClass: this.matchClass,
          incl: this.include,
          filt: this.filter,
          sources: this.sources
